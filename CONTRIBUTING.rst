...
1. Fork `python-fields <https://github.com/ionelmc/python-fields>`_
   (look for the "Fork" button).
2. Clone your fork locally::

    git clone git@github.com:YOURGITHUBNAME/python-fields.git
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.com/github/ionelmc/python-fields/pull_requests>`_
